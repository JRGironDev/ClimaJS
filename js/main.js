document.addEventListener("DOMContentLoaded", function () {
    ...
    if (validarFechaHoy()) {
      ...
      climas.forEach((clima) => {
        ...
        if (numeroRandom === id) {
          ...
          <p class="clima">Clima Mañana: ${estadoMañana}</p>
  ...
  function validarFechaHoy() {
    ...
    console.log(fechaIngresadaUTC.getUTCDate());
    console.log(fechaHoyUTC.getDate());
    console.log(fechaIngresadaUTC.getMonth());
    console.log(fechaHoyUTC.getMonth());
  ...
  function mostrarCardMañana(climas, numeroRandom, card) {
    ...
    climas.forEach((clima) => {
      ...
      if (numeroRandom === id) {
        htmlLeft += `<p>Mañana</p>
            <p class="clima">Clima: ${estadoMañana}</p>
    ...
    climas.forEach((clima) => {
      ...
      if (numeroRandom === id) {
        htmlCenter += `<p>Tarde</p>
                <p class="clima">Clima: ${estadoTarde}</p>
  ...
  function mostrarCardNoche(climas, numeroRandom, card) {
    ...
    climas.forEach((clima) => {
      ...
      if (numeroRandom === id) {
        htmlRight += `<p>Noche</p>
              <p class="clima">Clima: ${estadoNoche}</p>
